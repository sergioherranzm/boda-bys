    ...
    <>
      <div tw="flex flex-col items-center text-primary-400 text-center">
        ...
        <div tw="px-1">
          ...
          >
            <p tw="mt-6">
              Hace más de 5 años que el azar nos unió y comenzó nuestra
              historia. Una historia llena de momentos felices, risas, viajes,
              confidencias, cenas, charlas, juegos de mesa, pelis... y también
              alguna que otra lágrima, ¡todo hay que decirlo!
            </p>
            <p tw="mt-5">
              Hemos pasado hasta una pandemia de por medio, que nos separó a la
              fuerza y en la que nos echamos tremendamente de menos, pero que
              reforzó nuestra certeza de que estábamos hechos el uno para el
              otro.
            </p>
            <p tw="mt-5">
              Más adelante empezó la convivencia, en la que hemos seguido
              construyendo los pilares de nuestro amor, y ahora no nos
              imaginamos la vida el uno sin el otro. Así que, después de estos
              maravillosos años, hemos decidido dar un paso más:
            </p>
